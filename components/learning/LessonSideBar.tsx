...
export function LessonSidebar({
  ...
  return (
    <div className="flex flex-col h-full bg-white">
      ...
      <div className="flex-1 overflow-y-auto divide-y divide-gray-50 no-scrollbar pb-10 lg:pb-4">
        {lessons.map((section) => {
          ...
          return (
            <div key={section.id} className="bg-white">
              ...
              >
                <span className="text-[13px] font-bold text-gray-900 text-left pr-2">
                  {section.title}
                </span>
              ...
              {isOpen && (
                <div className="pb-2 bg-gray-50/30">
                    ...
                    return (
                      ...
                      >
                        <div className="flex items-center gap-2 overflow-hidden mr-2">
                          ...
                          <span
                            className={`truncate text-left ${isActive ? "font-semibold" : "font-medium"}`}
                          >
                            {sub.title}
                          </span>
                        </div>
                        ...
                        {isCompleted ? (
                          ...
                          <div
                            className={`w-4 h-4 rounded-full border-2 shrink-0 ${isActive ? "border-blue-400" : "border-gray-200"}`}
                          />
                        )}
                      </button>
                    );
